UnityAwe is a simple drag-and-drop C# script for using Awesomium in Unity. Simply add RenderToTexture.cs to your assets folder and drag the script onto any game object or GUI texture. 
